var K=(r,t,e)=>{if(!t.has(r))throw TypeError("Cannot "+e)};var u=(r,t,e)=>(K(r,t,"read from private field"),e?e.call(r):t.get(r)),m=(r,t,e)=>{if(t.has(r))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(r):t.set(r,e)},st=(r,t,e,s)=>(K(r,t,"write to private field"),s?s.call(r,e):t.set(r,e),e);var L=(r,t,e)=>(K(r,t,"access private method"),e);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const n of o.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function e(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(i){if(i.ep)return;i.ep=!0;const o=e(i);fetch(i.href,o)}})();/**
 * @license
 ...
 */class x extends E{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e;const t=super.createRenderRoot();return(e=this.renderOptions).renderBefore??(e.renderBefore=t.firstChild),t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Wt(e,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),(t=this._$Do)==null||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._$Do)==null||t.setConnected(!1)}render(){return P}}var ut;x._$litElement$=!0,x.finalized=!0,(ut=globalThis.litElementHydrateSupport)==null||ut.call(globalThis,{LitElement:x});const G=globalThis.litElementPolyfillSupport;G==null||G({LitElement:x});(globalThis.litElementVersions??(globalThis.litElementVersions=[])).push("4.0.5");var b,q,bt;class Vt extends x{constructor(){super();m(this,q);m(this,b,void 0);st(this,b,this.attachInternals())}static get properties(){return{icon:{type:String}}}static get styles(){return ft`
        ...
        `}render(){return Q`
            <section @click="${L(this,q,bt)}">
                <div class="inner">
                    <div class="front"></div>
                    <div class="back">${this.icon}</div>
                </div>
            </section>
        `}get selected(){return u(this,b).states.has("selected")}unselect(){u(this,b).states.delete("selected")}}b=new WeakMap,q=new WeakSet,bt=function(){u(this,b).states.add("selected"),this.dispatchEvent(new CustomEvent("memory-tile-click",{composed:!0}))};customElements.define("memory-tile",Vt);var _,w,k,X,D,St,B,Et,W,wt;class Kt extends x{constructor(){super();m(this,_);m(this,k);m(this,D);m(this,B);m(this,W);this.addEventListener("memory-tile-click",L(this,W,wt).bind(this))}static get properties(){return{pictures:{type:String},_order:{type:Array,state:!0}}}static get styles(){return ft`
        ...
        `}updated(e){e.has("pictures")&&(this.reset(),this.style.setProperty("--items",this.icons.length),this.style.setProperty("--cols",Math.ceil(Math.sqrt(this.icons.length))),this.style.setProperty("--rows",Math.floor(Math.sqrt(this.icons.length))))}get icons(){return this.pictures.split(",").map(s=>Array(2).fill(s)).flat()||[]}reset(){L(this,B,Et).call(this),u(this,_,w).forEach(e=>{e.inert=!1,e.unselect()})}}_=new WeakSet,w=function(){var e,s;return(s=(e=this.shadowRoot)==null?void 0:e.querySelectorAll)==null?void 0:s.call(e,"memory-tile")},k=new WeakSet,X=function(){return[...u(this,_,w)].filter(e=>e.selected===!0&&e.inert!==!0)},D=new WeakSet,St=function(){return[...u(this,_,w)].filter(e=>e.inert===!0)},B=new WeakSet,Et=function(){var i;let s=Array.from(Array(((i=u(this,_,w))==null?void 0:i.length)||0).keys()).map(o=>({value:o,sort:Math.random()})).sort((o,n)=>o.sort-n.sort).map(({value:o})=>o);this._order=s},W=new WeakSet,wt=function(e){if(u(this,k,X).length<2)return;this.inert=!0;const[s,i]=u(this,k,X);s.icon===i.icon?(this.shadowRoot.querySelector("#yes").play(),s.inert=!0,i.inert=!0,this.inert=!1,u(this,_,w).length===u(this,D,St).length&&window.setTimeout(()=>this.reset(),2e3)):(this.shadowRoot.querySelector("#no").play(),window.setTimeout(()=>{s.unselect(),i.unselect(),this.inert=!1},1e3))};customElements.define("memory-game",Kt);
